        ...
        <Section>
          ...
          <div className="w-full flex flex-col items-center gap-4 min-h-[500px]">
            <div className="container min-h-[500px] w-full flex flex-col gap-4 px-8 py-10 overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-800">
              <h2 className="text-lg dark:text-blue-400 text-blue-400">Что мы делаем?</h2>
              <p>
                Мы помогаем бизнесу из разных сфер — от медицинских центров и банкетных залов до ремонта телефонов и
                шиномонтажа
              </p>
              <h2 className="text-lg dark:text-blue-400 text-blue-400">Миссия</h2>
              <p>
              ...
              <h2 className="text-lg dark:text-blue-400 text-blue-400">Цифры и факты</h2>
