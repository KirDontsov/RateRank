...
export const Pagination: FC<PaginationProps> = ({
  ...
  const renderPageButton = (page: number) => (
    <button
      ...
      className={cn(
        'hidden px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-white rounded-md sm:inline dark:text-gray-200 hover:bg-blue-500 dark:hover:bg-blue-500 hover:text-white dark:hover:text-gray-200',
        { 'bg-blue-500 dark:bg-blue-500': page === currentPage },
        { 'dark:bg-gray-800 dark:dark:bg-gray-800': page !== currentPage },
      )}
    >
      {page}
    </button>
